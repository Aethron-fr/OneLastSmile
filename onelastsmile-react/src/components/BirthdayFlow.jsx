...
export default function BirthdayFlow({ onEnter, isPlaying, setIsPlaying }) {
  ...
  const screenData = {
    0: { icon:'fas fa-hand-holding-heart',  ornament:'Before anything else...',  heading:"I couldn\u2019t get you something expensive.", text:"No box. No big surprise.\n\nJust me, sitting here night after night,\npouring everything I had into this.\n\nI hope you feel that.", btnLabel:'I feel it', btnAction: ()=>{ tryStartMusic(); goNext(0) } },
