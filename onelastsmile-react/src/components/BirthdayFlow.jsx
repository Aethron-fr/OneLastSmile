...
export default function BirthdayFlow({ onEnter, isPlaying, setIsPlaying }) {
  ...
  const screenData = {
    0: { icon:'fas fa-heart',  ornament:'For you',  heading:"I couldn\u2019t buy you something expensive.", text:"So I built you something instead.\nI hope you feel how much of me went into this.", btnLabel:'Open it', btnAction: ()=>{ tryStartMusic(); goNext(0) } },
